  ...
  <div>
    <ul class="u-tabs">
      <li class="u-tabs__item">
        <a class="u-tabs__link" :class="{ 'is-active': tabName === 'a' }" @click="tabName = 'a'">菜单说明</a>
      </li>
      <li class="u-tabs__item">
        <a class="u-tabs__link" :class="{ 'is-active': tabName === 'b' }" @click="tabName = 'b'">菜单样式</a>
      </li>
    </ul>
        ...
        <div>
          ...
          <div class="u-field u-field--small">
            ...
            <div class="u-field__content">
              <div>
                <p class="u-inline">
                  <input class="u-input u-input--small" value="C:\Users\user\Documents" />
                </p>
              </div>
  ...
  methods: {
    ...
    confirmInfo() {
      shaonq.alert(
        ...
        {
          confirmText: '放弃修改',
          confirm: (index) => shaonq.toast('放弃修改'),
        }
      )
    },
    deleteInfo() {
      shaonq.alert('此操作将永久删除该文件, 是否继续?', {
        confirmText: '确定',
        confirmSkin: 'u-btn--red',
        confirm: (index) => shaonq.toast('删除成功'),
      })
    },
  },
}
